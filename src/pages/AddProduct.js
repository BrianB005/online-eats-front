    ...
    <Wrapper>
      ...
      <Form onSubmit={handleSubmit}>
        ...
        <InputWrapper>
          ...
          <Input name="category"  onChange={handleChange} placeholder="Category (lowercase)"/>
        </InputWrapper>
        <InputWrapper>
          <Label htmlFor="miniDescription">Product minidescription</Label>
          <Input name="miniDescription" onChange={handleChange} placeholder="Minidescription"/>
        </InputWrapper>
        <InputWrapper>
          <Label htmlFor="description">Product Description</Label>
          <TextArea   onChange={handleChange} name="description"placeholder="Description" rows={5}/>
        </InputWrapper>
